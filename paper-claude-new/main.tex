...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{GNN.jpg}
\caption{基于 SAT+GPS 的活性子图结构编码流程。左：从标量场网格中提取活性子图作为输入图；中：节点与边特征构造、SAT+GPS 编码；右：读出定长向量并计算差异。}
