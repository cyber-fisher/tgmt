...
% ---- 区间标注：区间编号 + 连通分量数 c + 区间总 Euler 示性数 χ（自下而上 I1..I7）----
% 每条边(分量)χ 初值 +1，区间总 χ = 各边 χ 之和 = c。
\node[ilab, align=center] at (4.28,0.5)  {$I_1$\\[-1pt]{\scriptsize$c{=}1,\ \chi{=}1$}};
\node[ilab, align=center] at (4.28,4.5)  {$I_2$\\[-1pt]{\scriptsize$c{=}2,\ \chi{=}2$}};
\node[ilab, align=center] at (4.28,9)    {$I_3$\\[-1pt]{\scriptsize$c{=}3,\ \chi{=}3$}};
\node[ilab, align=center] at (4.28,11.5) {$I_4$\\[-1pt]{\scriptsize$c{=}3,\ \chi{=}3$}};
\node[ilab, align=center] at (4.28,14)   {$I_5$\\[-1pt]{\scriptsize$c{=}2,\ \chi{=}2$}};
\node[ilab, align=center] at (4.28,18.5) {$I_6$\\[-1pt]{\scriptsize$c{=}2,\ \chi{=}2$}};
\node[ilab, align=center] at (4.28,23)   {$I_7$\\[-1pt]{\scriptsize$c{=}1,\ \chi{=}1$}};
  ...
  \begin{minipage}{15cm}
    ...
    {\sffamily\scriptsize\color{black!80}
      ...
      \begin{tabular}{@{}r@{~}l@{\hspace{2.4em}}r@{~}l@{}}
        ...
        $S_1,S_2$  & 鞍点（分量合并 / 分裂事件）       &
        $f{=}10,15$ & 右侧真实等值面的提取标量值 \\
      \end{tabular}\par}
  \end{minipage}%
};
